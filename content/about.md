...
Sekarang, aku ini sysadmin di sebuah perusaan IT di Solo, diamanahi untuk mengurus server Centos dan Debian.

~~Kalau mau nawarin job,~~ feel free to contact me at [`Telegram`](https://t.me/nalakawula). And If you think this site is worth to follow, just click this [`subscribe link`]({{site.baseurl}}/feed.xml) to get its RSS feed.

Articles on this site are licensed as [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)
